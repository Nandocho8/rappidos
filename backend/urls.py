...
from .viewset import Region_ViewSet, Comuna_ViewSet, User_ViewSet, Delivery_ViewSet, Cliente_ViewSet, Restaurante_ViewSet, Direcciones_ViewSet, Producto_ViewSet, Medio_Pago_ViewSet, Pedido_ViewSet, Detalle_Pago_ViewSet, Detalle_Pedido_ViewSet, Facturado_ViewSet, Facturacion_mensual_ViewSet, Pedido_Restaurant_ViewSet, Pedido_Delivery_ViewSet
...
router.register('api/pedido_delivery',
                Pedido_Delivery_ViewSet, 'pedido_delivery')
router.register('api/facturacion_mensual',
                Facturacion_mensual_ViewSet, 'facturacion_mensual')
router.register('api/pedido_restaurant',
                Pedido_Restaurant_ViewSet, 'pedido_restaurante')
